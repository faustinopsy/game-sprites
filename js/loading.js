...
const BACKGROUND_INICIAL = `url('./img/iorix.png') -270px 0px`;
const BACKGROUND_ATIVO = `url('./img/iorix.png') -270px -270px`;
...
function iniciarAnimacao(){
  ...
  iori.style.background = `url('./img/iorix.png') -270px -${posicaoY}px`
