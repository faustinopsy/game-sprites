...
const BACKGROUND_INICIAL = `url('https://faustinopsy.github.io/game-sprites/img/iorix.png') -270px 0px`;
const BACKGROUND_ATIVO = `url('https://faustinopsy.github.io/game-sprites/img/iorix.png') -270px -270px`;
...
function iniciarAnimacao(){
  ...
  iori.style.background = `url('https://faustinopsy.github.io/game-sprites/img/iorix.png') -270px -${posicaoY}px`
